    ...
    ResourceBase.prototype.resourceScroll = function (id, name) {
        ...
        if (this.parent.activeView.isTimelineView()) {
            ...
            if (this.parent.virtualScrollModule) {
                ...
                var isRendered = this.renderedResources.filter(function (e) {
                    return e.groupIndex === index;
                });
                if (((((Math.round(this.parent.element.querySelector('.' + cls.CONTENT_WRAP_CLASS).offsetHeight / 60)
